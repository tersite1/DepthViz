...
// #include <sensor_msgs/Imu.h> // Replaced with msgs.h
#include "msgs.h"
#include <sophus/se3.h>
// #include <tf/transform_broadcaster.h> // Not available on iOS

using namespace std;
using namespace Eigen;
using namespace Sophus;
using namespace custom_messages; // Add this namespace
...
struct MeasureGroup
{
  double vio_time;
  double lio_time;
  deque<ImuConstPtr> imu; // Changed from sensor_msgs::Imu::ConstPtr
  cv::Mat img;
  MeasureGroup()
  {
    vio_time = 0.0;
