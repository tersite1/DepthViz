#ifndef SUPER_LIO_CORE_H_
#define SUPER_LIO_CORE_H_
...
public:
  ...
  void setDataWrapper(const IDataWrapper::Ptr& wrapper){
...
protected:
  ...
  using StateFn = void (SuperLIOCore::*)();
  ...
  IDataWrapper::Ptr data_wrapper_;
